...
#if LV_IME_PINYIN_USE_K9_MODE
static const char *lv_btnm_def_pinyin_k9_map[LV_IME_PINYIN_K9_CAND_TEXT_NUM + 21] = {",\0",
                                                                                     "123\0",
                                                                                     "abc \0",
                                                                                     "def\0",
...
static const lv_pinyin_dict_t lv_ime_pinyin_def_dict[] = {{"a", "啊"},
                                                          {"ai", "愛"},
                                                          {"an", "安暗案"},
                                                          {"ba", "吧把爸八"},
                                                          {"bai", "百白敗"},
...
void lv_ime_pinyin_set_mode(lv_obj_t *obj, lv_ime_pinyin_mode_t mode)
{
    ...
    if (pinyin_ime->mode == LV_IME_PINYIN_MODE_K9)
    {
        ...
        lv_keyboard_set_map(pinyin_ime->kb, LV_KEYBOARD_MODE_USER_1, (const char **)lv_btnm_def_pinyin_k9_map, default_kb_ctrl_k9_map);
...
static void lv_ime_pinyin_kb_event(lv_event_t *e)
{
    ...
    if (code == LV_EVENT_VALUE_CHANGED)
    {
        ...
        else if ((lv_strcmp(txt, "ABC") == 0) || (lv_strcmp(txt, "abc") == 0) || (lv_strcmp(txt, "1#") == 0) || (lv_strcmp(txt, LV_SYMBOL_OK) == 0))
        {
            pinyin_ime_clear_data(obj);
            return;
        }
