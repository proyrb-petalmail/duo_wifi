...
lv_pinyin_dict_t lv_ime_pinyin_dict[] = {
    ...
    {"fo", "佛"},
    {"fou", "否"},
    {"fu", "夫敷肤孵扶辐幅氟符伏俘服浮涪福袱弗甫抚辅俯釜斧腑府腐赴副覆赋复傅付阜父腹负富讣附妇缚咐"
           "佛拂脯"},
    {"ga", "噶嘎夹咖"},
    {"gai", "该改概钙溉盖芥"},
    {"gan", "干甘杆柑竿肝赶感秆敢赣乾"},
    ...
    {"hun", "昏婚魂浑混荤"},
    {"huo", "活伙火获或惑霍货祸豁和"},
    {"ji", "击圾基机畸积箕肌饥迹激讥鸡姬绩吉极棘辑籍集及急疾汲即嫉级挤几脊己蓟技冀季伎剂悸济寄寂计"
           "记既忌际妓继纪给稽缉祭藉期奇齐系"},
    ...
    {"sheng", "声生甥牲升绳剩胜圣乘省盛"},
    {"shi", "师失狮施湿诗尸虱十时蚀实史矢使屎驶始式示士世柿事拭誓逝势是嗜噬适仕侍释饰市恃室视试匙石"
            "拾食识氏似嘘殖峙什"},
    {"shou", "收手首守寿授售受瘦兽熟"},
    ...
    {"yi", "一壹医揖铱依伊衣颐夷移仪胰疑沂宜姨彝椅蚁倚已乙矣以艺抑易邑亿役臆逸肄疫亦裔意毅忆义益溢"
           "诣议谊译异翼翌绎遗屹"},
    ...
    {"yu", "迂淤于盂榆虞愚舆逾鱼愉渝渔隅予娱雨与屿禹宇语羽玉域芋郁遇喻峪御愈欲狱誉浴寓裕预豫驭尉余"
           "俞吁育"},
    ...
    {"zhi",
     "芝支蜘知肢脂汁之织职直植执值侄址指止趾只旨纸志挚掷至致置帜制智秩稚质炙痔滞治窒识枝吱殖峙"},
    {"zhong", "中盅忠钟衷终肿仲众种重"},
    {"zhou", "舟周州洲诌轴肘帚咒皱宙昼骤粥"},
